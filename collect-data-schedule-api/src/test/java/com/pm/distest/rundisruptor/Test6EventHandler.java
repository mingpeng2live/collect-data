...
import cn.com.admaster.utilities.random.RandomUtilities;
 ...
 * @description
 */
public class Test6EventHandler implements WorkEventHandler<Job> {
...
//        LockSupport.parkNanos(RandomUtilities.getNum(0, 20));
        logger.info(" 6 name jobId: " + job.getJobId());
    }
